...
class MainWindow(wx.Frame):
	def __init__(self, parent, title):
        ...
        # FavIcon
		icon = wx.Icon('./club.png', type=wx.BITMAP_TYPE_PNG)
		self.SetIcon(icon)
	...
	def OnAbout(self,e):
		...
		message = """Pairs Automated Seeding Service ver 0.1.0
...
app = wx.App(False)
frame = MainWindow(None, "Pairs Automated Seeding Service (PASS)")
verifyFiles()
app.MainLoop()
